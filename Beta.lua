...
local Themes = {
    ...
    LycHubv1 = {
		...
		AcrylicGradient = ColorSequence.new(Color3.fromRGB(0, 0, 0), Color3.fromRGB(0, 0, 0)),
		AcrylicNoise = 1,
		TitleBarLine = Color3.fromRGB(30, 0, 60),
		Tab = Color3.fromRGB(60, 0, 100),
		Element = Color3.fromRGB(20, 0, 40),
		ElementBorder = Color3.fromRGB(0, 0, 0),
		InElementBorder = Color3.fromRGB(60, 0, 100),
		ElementTransparency = 0.95,
		ToggleSlider = Color3.fromRGB(80, 0, 130),
		ToggleToggled = Color3.fromRGB(200, 150, 255),
		SliderRail = Color3.fromRGB(100, 0, 150),
		DropdownFrame = Color3.fromRGB(40, 0, 70),
		DropdownHolder = Color3.fromRGB(0, 0, 0),
		DropdownBorder = Color3.fromRGB(0, 0, 0),
		DropdownOption = Color3.fromRGB(80, 0, 130),
		Keybind = Color3.fromRGB(80, 0, 130),
		Input = Color3.fromRGB(80, 0, 130),
		InputFocused = Color3.fromRGB(0, 0, 0),
		InputIndicator = Color3.fromRGB(120, 0, 180),
		InputIndicatorFocus = Color3.fromRGB(200, 150, 255),
		Dialog = Color3.fromRGB(0, 0, 0),
		DialogHolder = Color3.fromRGB(0, 0, 0),
		DialogHolderLine = Color3.fromRGB(30, 0, 60),
		DialogButton = Color3.fromRGB(20, 0, 40),
		DialogButtonBorder = Color3.fromRGB(60, 0, 90),
		DialogBorder = Color3.fromRGB(50, 0, 80),
		DialogInput = Color3.fromRGB(20, 0, 40),
		DialogInputLine = Color3.fromRGB(120, 0, 180),
		Text = Color3.fromRGB(220, 200, 255),
		SubText = Color3.fromRGB(170, 120, 220),
		Hover = Color3.fromRGB(80, 0, 130),
		HoverChange = 0.04,
	},
	LycHubv2 = {
		Name = "LycHubv2",
		...
		AcrylicMain = Color3.fromRGB(0, 0, 0),
		AcrylicBorder = Color3.fromRGB(25, 0, 50),
		AcrylicGradient = ColorSequence.new(Color3.fromRGB(0, 0, 0), Color3.fromRGB(20, 0, 40)),
		AcrylicNoise = 1,
		TitleBarLine = Color3.fromRGB(35, 0, 70),
		Tab = Color3.fromRGB(70, 0, 120),
		Element = Color3.fromRGB(30, 0, 60),
		ElementBorder = Color3.fromRGB(0, 0, 0),
		InElementBorder = Color3.fromRGB(70, 0, 120),
		ElementTransparency = 0.95,
		ToggleSlider = Color3.fromRGB(100, 0, 160),
		ToggleToggled = Color3.fromRGB(220, 170, 255),
		SliderRail = Color3.fromRGB(120, 0, 190),
		DropdownFrame = Color3.fromRGB(50, 0, 90),
		DropdownHolder = Color3.fromRGB(0, 0, 0),
		DropdownBorder = Color3.fromRGB(0, 0, 0),
		DropdownOption = Color3.fromRGB(100, 0, 160),
		Keybind = Color3.fromRGB(100, 0, 160),
		Input = Color3.fromRGB(100, 0, 160),
		InputFocused = Color3.fromRGB(0, 0, 0),
		InputIndicator = Color3.fromRGB(140, 0, 200),
		InputIndicatorFocus = Color3.fromRGB(220, 170, 255),
		Dialog = Color3.fromRGB(0, 0, 0),
		DialogHolder = Color3.fromRGB(0, 0, 0),
		DialogHolderLine = Color3.fromRGB(35, 0, 70),
		DialogButton = Color3.fromRGB(30, 0, 60),
		DialogButtonBorder = Color3.fromRGB(70, 0, 100),
		DialogBorder = Color3.fromRGB(60, 0, 90),
		DialogInput = Color3.fromRGB(30, 0, 60),
		DialogInputLine = Color3.fromRGB(140, 0, 200),
		Text = Color3.fromRGB(230, 210, 255),
		SubText = Color3.fromRGB(190, 140, 230),
		Hover = Color3.fromRGB(100, 0, 160),
		HoverChange = 0.05,
	},
	LycHubv3 = {
		Name = "LycHubv3",
		...
		AcrylicMain = Color3.fromRGB(0, 0, 0),
		AcrylicBorder = Color3.fromRGB(30, 0, 60),
		AcrylicGradient = ColorSequence.new(Color3.fromRGB(10, 0, 20), Color3.fromRGB(0, 0, 0)),
		AcrylicNoise = 1,
		TitleBarLine = Color3.fromRGB(40, 0, 80),
		Tab = Color3.fromRGB(80, 0, 140),
		Element = Color3.fromRGB(40, 0, 80),
		ElementBorder = Color3.fromRGB(0, 0, 0),
		InElementBorder = Color3.fromRGB(80, 0, 140),
		ElementTransparency = 0.95,
		ToggleSlider = Color3.fromRGB(120, 0, 200),
		ToggleToggled = Color3.fromRGB(230, 180, 255),
		SliderRail = Color3.fromRGB(150, 0, 220),
		DropdownFrame = Color3.fromRGB(60, 0, 100),
		DropdownHolder = Color3.fromRGB(0, 0, 0),
		DropdownBorder = Color3.fromRGB(0, 0, 0),
		DropdownOption = Color3.fromRGB(120, 0, 200),
		Keybind = Color3.fromRGB(120, 0, 200),
		Input = Color3.fromRGB(120, 0, 200),
		InputFocused = Color3.fromRGB(0, 0, 0),
		InputIndicator = Color3.fromRGB(160, 0, 230),
		InputIndicatorFocus = Color3.fromRGB(230, 180, 255),
		Dialog = Color3.fromRGB(0, 0, 0),
		DialogHolder = Color3.fromRGB(0, 0, 0),
		DialogHolderLine = Color3.fromRGB(40, 0, 80),
		DialogButton = Color3.fromRGB(40, 0, 80),
		DialogButtonBorder = Color3.fromRGB(80, 0, 120),
		DialogBorder = Color3.fromRGB(70, 0, 100),
		DialogInput = Color3.fromRGB(40, 0, 80),
		DialogInputLine = Color3.fromRGB(160, 0, 230),
		Text = Color3.fromRGB(240, 220, 255),
		SubText = Color3.fromRGB(200, 150, 240),
		Hover = Color3.fromRGB(120, 0, 200),
		HoverChange = 0.05,
	},
	LycHubv4 = {
		Name = "LycHubv4",
